...
const LIVERY_SRC = path.resolve(__dirname, '..', 'hues-a339x-mau/src');
const LIVERY_OUT = path.resolve(__dirname, '..', 'hues-a339x-mau/out');
...
createPackageFiles(path.resolve(LIVERY_OUT, 'hues-livery-a339x-airmauritius-package'), 'manifest-base.json');
